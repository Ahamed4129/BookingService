...
namespace myhomeapplication.Controllers
{
    ...
    public class BookingController : ControllerBase
    {
        ...
        // GET: api/bookings/5
        [HttpGet("{user}")]
        public async Task<ActionResult<Booking>> GetBooking(string user)
        {
                var booking = await _context.Bookings.Where(b => b.User == user).OrderByDescending(b => b.AppointmentDate).ToListAsync();
